...
public class VisualContIntegrationTest {
        ...
        public void testSendInvoiceWithIgvIncluded() {
                ...
                InvoiceDomain invoice = new InvoiceDomain(client, 1, 18.0, InvoiceCurrency.PEN, InvoiceType.FACTURA,
                                0);
                invoice.addItemWithIncludedIgv(new InvoiceItemDomain("Item 1","631210", "aaa", 1, new BigDecimal(58)));
        ...
        public void savedAndSendInvoice() {
                ...
                invoiceDomain.addItemWithIncludedIgv(
                                new InvoiceItemDomain("Item 1","631210", "aaa", 1, new BigDecimal(100)));
