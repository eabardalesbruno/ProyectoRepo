...
public class InvoiceTests {
        ...
        void verfiedTotalPayment() {
                ...
                invoice.addItemWithIncludedIgv(
                                new InvoiceItemDomain("Item 1","631210", "aaa", 1, new BigDecimal(50)));
                invoice.addItemWithIncludedIgv(
                                new InvoiceItemDomain("Item 2","631210", "aaa", 1, new BigDecimal(20)));
                invoice.addItemWithIncludedIgv(
                                new InvoiceItemDomain("Item 3","631210", "aaa", 1, new BigDecimal(30)));
                Mono<InvoiceDomain> invoiceMono = Mono
                                .just(invoice);
                StepVerifier.create(invoiceMono)
        ...
        void verfiedPaymentWithIgvNotIncluded() {
                ...
                InvoiceDomain invoice = new InvoiceDomain(client, 1, 18.0, InvoiceCurrency.PEN, InvoiceType.BOLETA,
                                0);
                invoice.addItem(
                                new InvoiceItemDomain("Reserva Habitación Doble","631210", "AAA", 1, new BigDecimal("100.00")));
                invoice.addItem(new InvoiceItemDomain("Servicio WiFi","631210", "CCC", 5, new BigDecimal("10.00")));
        ...
        void verfiedSubTotalPayment() {
                ...
                InvoiceDomain invoice = new InvoiceDomain(client, 1, 18, InvoiceCurrency.PEN, InvoiceType.BOLETA,
                                0);
                invoice.addItem(new InvoiceItemDomain("Item 2","631210", "aaa", 1, new BigDecimal(20)));
                invoice.addItem(new InvoiceItemDomain("Item 3","631210", "aaa", 1, new BigDecimal(30)));
                invoice.addItem(new InvoiceItemDomain("Item 1","631210", "aaa", 1, new BigDecimal(50)));
        ...
        void incrementCorrelativeBoleta() {
                ...
                InvoiceDomain invoiceDomain = new InvoiceDomain(client, 82, 18, InvoiceCurrency.USD,
                                InvoiceType.BOLETA,
                                0);
                invoiceDomain.addItem(new InvoiceItemDomain("Item 1","631210", "aaa", 1, new BigDecimal(50)));
                invoiceDomain.addItem(new InvoiceItemDomain("Item 2","631210", "aaa", 1, new BigDecimal(20)));
                invoiceDomain.addItem(new InvoiceItemDomain("Item 3","631210", "aaa", 1, new BigDecimal(30)));
                invoiceDomain.setKeySupplier("wdwdwd");
                invoiceDomain.setSupplierNote("No se acepto tu factura");
                invoiceDomain.setStatus(InvoiceStatus.REJECTED);
                Mono<InvoiceTypeEntity> invoiceTypeEntity = this.invoiceTypeRepsitory
        ...
        void saveInvoiceWithItems() {
                ...
                invoiceDomain.addItemWithIncludedIgv(
                                new InvoiceItemDomain("Reserva Habitación Doble","631210", "AAA", 2, new BigDecimal("100.00")));
                invoiceDomain.addItemWithIncludedIgv(new InvoiceItemDomain("Reserva Habitación Sencilla", "631210","BBB", 1,
                                new BigDecimal("80.00")));
                invoiceDomain.addItemWithIncludedIgv(
                                new InvoiceItemDomain("Servicio WiFi","631210", "CCC", 3, new BigDecimal("10.00")));
                invoiceDomain.setKeySupplier("wdwdwd");
                invoiceDomain.setSupplierNote("No se acepto tu factura");
        ...
        void saveInvoiceItems() {
                ...
                InvoiceDomain invoiceDomain = new InvoiceDomain(client, 82, 18, InvoiceCurrency.USD,
                                InvoiceType.FACTURA,
                                0);
                invoiceDomain.addItem(new InvoiceItemDomain("Item 1","631210", "aaa1", 1, new BigDecimal(50)));
                invoiceDomain.addItem(new InvoiceItemDomain("Item 2", "631210","aaa2", 1, new BigDecimal(20)));
                invoiceDomain.addItem(new InvoiceItemDomain("Item 3", "631210","aaa3", 1, new BigDecimal(30)));
                invoiceDomain.setKeySupplier("wdwdwd");
                invoiceDomain.setSupplierNote("No se acepto tu factura");
                invoiceDomain.setStatus(InvoiceStatus.REJECTED);
