...
public interface RoomOfferRepository extends R2dbcRepository<RoomOfferEntity, Integer> {
    ...
    @Query("""
            ...
            FROM viewroomofferreturn v
             ...
             and v.kidcapacity+v.infantcapacity+v.adultcapacity+v.adultextra+v.adultmayorcapacity>=(:adultCapacity+:adultMayorCapacity+:kidCapacity+:adultExtra+:infantCapacity)
            and v.kidcapacity+v.infantcapacity>=:kidCapacity
            ORDER BY v.roomofferid ASC
            """)
    Flux<ViewRoomOfferReturn> findFilteredV2(Integer roomTypeId,
