    ...
    public String execute() {
        String body = """
                <section class="container-body-email">
                    <h3 class="title">
                        ¡Lo sentimos, %clientName! Rechazamos tu pago.
                    </h3>
                     <p class="description">
                        Verificamos tu pago para la reserva del <strong>%roomName</strong>.
                    </p>
                    <p class="description">
                        Lo sentimos, pero no hemos podido completar su pago en este momento.
                    </p>
                
                    <p class="font-size">
                        <div class="container-reservation-warning">
                          <p><div class="icon-container">⚠️</div>
                          <strong style="padding-left: 2px;">Motivo de rechazo</strong></p>
                          <p class="text-warning">%reason</p>
                          <p class="text-warning">Gracias por su comprensión.</p>
                        </div>
                    </p>
