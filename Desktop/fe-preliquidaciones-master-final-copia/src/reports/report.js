...
var browserType = process.env.BROWSER_TYPE || 'chromium';
...
(function upload() {
    return __awaiter(this, void 0, void 0, function () {
        var uploadQMetry, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    uploadQMetry = new upload_1.UploadQMetry();
                    return [4 /*yield*/, uploadQMetry.uploadQMetry()];
                case 1:
                    _a.sent();
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Error during upload to QMetry:', error_1);
                    return [3 /*break*/, 3];
